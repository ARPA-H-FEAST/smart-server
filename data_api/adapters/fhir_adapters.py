...
class Patient:
    ...
    def __init__(self, kwargs):
        ...
        self.active = kwargs.get("active", None) # Whether this patient's record is in active use
        self.name = kwargs.get("human_name", None) # A name associated with the patient
        self.telecom = kwargs.get("contact_point", None) # A contact detail for the individual
        self.gender = kwargs.get("gender", None), # male | female | other | unknown
        self.birthDate = kwargs.get("birthdate", None), # The date of birth for the individual
        ...
        self.maritalStatus = kwargs.get("CodeableConcept") # Marital (civil) status of a patient
...
class DiagnosticReport:
    ...
    def __init__(self, kwargs):
        ...
        self.result = kwargs.get("result", None)
            ...
            # I Observations
        self.note = kwargs.get("annotation", None) # Comments about the diagnostic report
...
class Organization:
    ...
    def __init__(self, kwargs):
        ...
        # from Resource: id, meta, implicitRules, and language
        # from DomainResource: text, contained, extension, and modifierExtension
        self.identifier = kwargs.get("identifier")  # Identifies this organization  across multiple systems
        self.active = kwargs.get("active", None) # Whether the organization's record is still in active use
        self.type = kwargs.get("codeable_concept", None) # Kind of organization
        self.name = kwargs.get("organization_name", None) # I Name used for the organization
        self.alias = kwargs.get("aliases", None) # A list of alternate names that the organization is known as, or was known as in the past
        self.description = kwargs.get("description_markdown", None), # Additional details about the Organization that could be displayed as further information to identify the Organization beyond its name
        self.contact = kwargs.get("contact", None)  # Official contact details for the Organization
        self.partOf = kwargs.get("part_of", None) # The organization of which this organization forms a part
        self.endpoint = kwargs.get("endpoints", None) # Technical endpoints providing access to services operated for the organization
        self.qualification = kwargs.get("qualifications", None) # Qualifications, certifications, accreditations, licenses, training, etc. pertaining to the provision of care
            #     [{
            #     "[{ 
...
class FamilyMemberHistory:
    ...
    def __init__(self, kwargs):
        ...
        self.instantiatesCanonical = kwargs.get("cannonical", None)  # Instantiates FHIR protocol or definition
        self.instantiatesUri = kwargs.get("uri", None) # Instantiates external protocol or definition
        self.status = kwargs.get("code") # R!  partial | completed | entered-in-error | health-unknown
        self.dataAbsentReason = kwargs.get("codeable_concept", None) # subject-unknown | withheld | unable-to-obtain | deferred
        self.patient = kwargs.get("patient") # R!  Patient history is about
        self.date = kwargs.get("date_time", None), # When history was recorded or last updated
        ...
        self.relationship = kwargs.get("relationship"), # R!  Relationship to the subject icon
...
class GenomicStudy:
    ...
    def __init__(self, kwargs):
        ...
        self.status = kwargs.get("status"), # R!  registered | available | cancelled | entered-in-error | unknown
        self.type = kwargs.get("codeable_concept") # The type of the study (e.g., Familial variant segregation, Functional variation detection, or Gene expression profiling)
        self.subject = kwargs.get("subject") # See comment below 
                ...
                #   Patient|Substance
                # ) }
        self.encounter = kwargs.get("encounter", None) # The healthcare event with which this genomics study is associated
        self.startDate = kwargs.get("start_date") # When the genomic study was started
        self.basedOn = kwargs.get("based_on", None) # Event resources that the genomic study is based on. Expected values are: Reference(ServiceRequest|Task)
        ...
        self.note = kwargs.get("annotation", None) # Comments related to the genomic study
